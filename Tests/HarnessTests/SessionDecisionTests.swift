...
// MARK: - Randomisation
//
// ``SeededGenerator`` lives in its own file: `SessionMachineTests` randomises too, and a second
// copy of a PRNG is a second constant to get wrong in the one place reproducibility comes from.
